...
public class FileReconstructorTest {
    ...
    @Test
    void testBasicReconstruction() throws IOException, NoSuchAlgorithmException {
    ...
    @Test
    void testMultiChunkReconstruction() throws IOException, NoSuchAlgorithmException {
    ...
    @Test
    void testListAvailableFiles() throws NoSuchAlgorithmException {
